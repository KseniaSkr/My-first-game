...
while playing:
    ...
    if keyes[K_DOWN] and player_rect.bottom < HEIGHT:
        player_rect = player_rect.move(player_move_down)
    if keyes[K_RIGHT] and player_rect.right < WIDTH:
        player_rect = player_rect.move(player_move_right)
    if keyes[K_UP] and player_rect.top < HEIGHT:
        player_rect = player_rect.move(player_move_up)
    if keyes[K_LEFT] and player_rect.left < WIDTH:
